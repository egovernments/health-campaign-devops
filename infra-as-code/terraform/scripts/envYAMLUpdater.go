...
func main() {
	...
	// Read the YAML file
	yamlFile, err := ioutil.ReadFile("../../../config-as-code/helm/environments/egov-demo.yaml")
	if err != nil {
	...
	err = ioutil.WriteFile("../../../config-as-code/helm/environments/egov-demo.yaml", []byte(output), 0644)
	if err != nil {
